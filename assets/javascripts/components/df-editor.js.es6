...
export default Ember.Component.extend({
	...
	,createEditor: function() {
		return new Markdown.DfEditor(
			Discourse.Markdown.markdownConverter({sanitize: true})
			, this._suffix
			, {
				/**
				 * 2015-07-26
				 * Параметр containerElement был добавлен вот этим коммитом:
				 * https://github.com/discourse/discourse/commit/20a338362fd144835ae333e185f47b975ce0cb88
				 * «FIX: Allow multiple pagedown editors at once.»
				 * https://github.com/discourse/discourse/blob/v1.4.0.beta6/app/assets/javascripts/discourse/components/pagedown-editor.js.es6#L10
				 */
